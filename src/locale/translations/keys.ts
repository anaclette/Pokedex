export enum TranslationKeys {
  ...
  NAVIGATE_TO_PIKADEX_BUTTON_LABEL = 'NAVIGATE_TO_PIKADEX_BUTTON_LABEL',
  REMOVE_ALL_FAVOURITES = 'REMOVE_ALL_FAVOURITES',
  DELETE_ALL_ALERT_TITLE = 'DELETE_ALL_ALERT_TITLE',
  DELETE_ALL_ALERT_MESSAGE = 'DELETE_ALL_ALERT_MESSAGE',
  DELETE_ALL_OPTION_ONE = 'DELETE_ALL_OPTION_ONE',
  DELETE_ALL_OPTION_TWO = 'DELETE_ALL_OPTION_TWO',
  FLAG_BUTTON_IMAGE = 'FLAG_BUTTON_IMAGE',
}
